...
export default function JukeboxArea(): JSX.Element {
  ...
  const queueItems = [
    ...
    { title: "Travis Scott - Never Catch Me", image: "/placeholder2.jpg", by: "playerIDShouldGoHERE"},
                ...
                <GridItem>
                  <VStack spacing={4} height="100%">
                    {isQueueVisible ? (
                      // Queue View
                      <Box width="100%">
                        <VStack spacing={3} align="stretch" bg="gray.50" p={4} borderRadius="md" height="300px" overflowY="auto">
